            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb justify-content-end">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">dome</a></li>
                                        ...
                                        <div class="drive-item module text-center" id="r_<?= $row->id_file_rcvd  ?>">
                                            <div class="drive-item-inner module-inner">
                                                ...
                                                <div class="drive-item-thumb">
                                                    <a href="#"><?= viewExtension($row->ext_rcvd_d, $row->name_rcvd, $id,'receivedVacation') ?></a>
                                                </div>
                                            </div>
                                            <div class="drive-item-footer module-footer">
                                                <ul class="utilities list-inline">
                                                    <li><a class="text-dark" href="<?= base_url('assets/files/receivedVacation/' . $id . "/" . $row->name_rcvd) ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Download" download="<?= $row->name_rcvd ?>"><i class="fa fa-download"></i></a>
                                                    </li>
