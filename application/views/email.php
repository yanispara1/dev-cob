                    ...
                    <tr>
                        <td style="border-bottom:1px solid #e7e7e7;">
                          ...
                          <![endif]-->
                                                            ...
                                                            <a href="<?= base_url('confirmar-cuenta/'.$code); ?>" style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;">My Order</a>
                                                            <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
