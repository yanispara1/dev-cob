...
class Dashboard extends CI_Controller
{
	...
	public function profile()
	{
		...
		$data['links'] = array(
			...
			'<link href="' . base_url() . 'assets/node_modules/signature-pad/jquery.signaturepad.css">'
		);
		...
		$data['scripts'] = array(
			...
			'<script src="' . base_url() . 'assets\node_modules\signature-pad\bezier.js"></script>',
			'<script src="' . base_url() . 'assets\node_modules\signature-pad\jquery.signaturepad.js"></script>',
			'<script src="' . base_url() . 'assets\node_modules\signature-pad\numeric-1.2.6.min.js"></script>',
