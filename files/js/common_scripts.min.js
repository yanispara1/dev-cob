! function(t, e) {
	...
	function vt(t, e, i, s, n) {
		var o, r, a, l, h, c = 4 < arguments.length && void 0 !== n && n,
			u = {
				top: 0,
				left: 0
			},
	...
	var $t = {
			...
			modifiers: {
				shift: {
					...
					enabled: !0,
					fn: function(t) {
						var e, i, s, n, o, r, a, l = t.placement,
							h = l.split("-")[0],
							c = l.split("-")[1];
			...
			return t.toggle = function() {
				...
				if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
					for (var e = [].slice.call(document.querySelectorAll(ne)), i = 0, s = e.length; i < s; i++) {
						var n, o, r = h._getParentFromElement(e[i]),
							a = f(e[i]).data(Qt),
							l = {
								relatedTarget: e[i]
							};
	...
	var he = "modal",
		...
		Ie = function() {
			...
			return t.toggle = function(t) {
				...
				var o, r = f.Event("shown.bs.modal", {
					relatedTarget: t
				});
		...
		ki = function() {
			...
			return t.show = function() {
				...
				this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(wi) || f(this._element).hasClass("disabled") || (e = f(this._element).closest(".nav, .list-group")[0], i = g.getSelectorFromElement(this._element), e && (s = "UL" === e.nodeName || "OL" === e.nodeName ? xi : Ci, n = (n = f.makeArray(f(e).find(s)))[n.length - 1]), o = f.Event("hide.bs.tab", {
					...
					relatedTarget: n
				}), n && f(n).trigger(o), f(this._element).trigger(r), r.isDefaultPrevented() || o.isDefaultPrevented() || (i && (t = document.querySelector(i)), this._activate(this._element, e), a = function() {
...
function(f) {
	f.widget("ui.resizable", f.ui.mouse, {
		...
		start: function(t, e) {
			var i, s, n, o, r, a, l, h = f(this).data("resizable"),
				c = h.options,
				u = h.element,
				d = c.containment,
	...
	function(h) {
		h.extend(h.fn, {
			...
			rules: function(t, e) {
				...
				var a, l = h.validator.normalizeRules(h.extend({}, h.validator.classRules(i), h.validator.attributeRules(i), h.validator.dataRules(i), h.validator.staticRules(i)), i);
