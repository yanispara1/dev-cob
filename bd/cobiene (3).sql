...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2023 a las 21:31:26
...
(73, '', '', '07082023052944_61870.docx', ''),
(74, 'MEDICO', 'sssss', '07082023053005_96660.docx', ''),
(75, 'MEDICO', 'sssss', '07082023053009_12077.docx', ''),
(76, 'MEDICO', 'sssss', '07082023053009_10966.docx', ''),
(77, 'MEDICO', 'sssss', '07082023053010_11135.docx', ''),
(78, 'MEDICO', 'sssss', '07082023053011_57516.docx', ''),
(79, 'MEDICO', 'sssss', '07082023053011_3859.docx', ''),
(80, 'MEDICO', 'sssss', '07082023053012_74007.docx', ''),
(81, 'MEDICO', 'sssss', '07082023053018_75678.docx', ''),
(82, 'MEDICO', 'sssss', '07082023053020_74459.docx', ''),
(83, 'MEDICO', 'sssss', '07082023053021_36204.docx', '');
...
INSERT INTO `tbl_drive_rcvd` (`id_file_rcvd`, `rcvd_id`, `name_rcvd`, `ext_rcvd_d`) VALUES
(35, 3, '64d170b3d849f_0.jpg', 'jpg'),
(36, 1, '64d63941a7a4f_0.jpg', 'jpg'),
(37, 347, '64d655b8732be_0.jpg', 'jpg'),
(38, 347, '64d656147b332_0.jpg', 'jpg'),
(39, 347, '64d6562848ffa_0.jpg', 'jpg'),
(40, 347, '64d657cd999af_0.jpg', 'jpg');
...
INSERT INTO `tbl_vacation` (`id`, `reason`, `quantity_day`, `start__vacation`, `end_vacation`, `destination`, `photo_support`, `date_wekend`, `weekend`, `days_computed`, `dni_user`, `id_user`, `days_used`, `status`) VALUES
(347, 'Descanso', '4', '2023-08-15', '2023-08-20', 'Ciudad de Cusco', 'assets/images/soportes/vacaciones/', '  2023-08-18', 2, 4, 0, 24, 6, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_vacation_rcvd`
--

CREATE TABLE `tbl_vacation_rcvd` (
  `id_file_rcvd` int(7) NOT NULL,
  `rcvd_id` int(7) NOT NULL,
  `name_rcvd` varchar(100) NOT NULL,
  `ext_rcvd_d` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indices de la tabla `tbl_vacation_rcvd`
--
ALTER TABLE `tbl_vacation_rcvd`
  ADD PRIMARY KEY (`id_file_rcvd`);
...
--
ALTER TABLE `tbl_background`
  MODIFY `id_bck` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
...
--
ALTER TABLE `tbl_drive_rcvd`
  MODIFY `id_file_rcvd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
-- AUTO_INCREMENT de la tabla `tbl_vacation_rcvd`
--
ALTER TABLE `tbl_vacation_rcvd`
  MODIFY `id_file_rcvd` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
